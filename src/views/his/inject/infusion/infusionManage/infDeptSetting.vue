      ...
      <el-col class="ht" :span="16">
        <div class="his-module his-small">
          ...
          > -->
            ...
            >
              <!-- 输液科室 -->
              <el-table-column prop="ksdm" label="输液科室">
        ...
        <div class="his-module his-small">
          ...
          <el-form :model="forms" ref="formValidate" :rules="rules" label-width="94px">
            <el-row :gutter="10" type="flex" justify="center">
              <el-col :span="18">
                <el-form-item label="输液科室" prop="ksdm">
                  <el-select v-model="forms.ksdm" placeholder="请选择输液科室" :disabled="true">
                    <el-option
            ...
            <el-row :gutter="10" type="flex" justify="center">
              <el-col :span="18">
                <el-form-item label="下一顺序号" prop="xysxh" :class="!isAdd?'is-disabled':''">
                  <el-input v-model="forms.xysxh" placeholder="请输入下一顺序号" :disabled="!isAdd"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="10" type="flex" justify="center">
...
export default class extends Vue {
  ...
  private rules: any = {
    ksdm: [
      {required: true, message: '输液科室不能为空', trigger: 'blur'},
    ],
    tmscgz: [
  ...
  private deptList: any[] = Vue.prototype.$qiankun ? Vue.prototype.$store.webSqlDict.INFUSION_DEPT : this.$store.state.webSqlDict.INFUSION_DEPT // 输液科室列表
  ...
  // 获取列表
  private getList(){
    aQuerySyksList({kslb: 1, ksdm: this.ksdm}).then((res: any) => {
      if(res){
