    ...
    <div class="his-module his-small" style="padding: 8px 10px">
      ...
      >
        ...
        >
          ...
          <el-table-column label="项目归并" prop="fylb" min-width="90px">
          ...
          <el-table-column label="门诊归并" prop="mzgb" min-width="90px">
            <template slot-scope="scope">
              <div>
          ...
          <el-table-column label="住院归并" prop="zygb" min-width="90px">
            <template slot-scope="scope">
              <div>
          ...
          <el-table-column label="病案首页归并" prop="basygb" min-width="100px" show-overflow-tooltip>
            <template slot-scope="scope">
              <div>
