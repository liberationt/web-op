        ...
        <div class="his-module his-small" style="padding: 8px 10px">
          ...
          >
            ...
            >
              ...
              <el-table-column label="备注信息" prop="bzxx"></el-table-column>
              <el-table-column label="操作" width="93" class-name="action-btns" align="center">
                <template slot-scope="scope">
                  <!-- 作废/取消作废 -->
