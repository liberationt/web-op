...
<template>
  <div>
        ...
        <div class="his-module his-small" style="padding: 8px 10px">
          ...
          >
            ...
            >
              ...
              <el-table-column label="名称" prop="sfmc" min-width="100" show-overflow-tooltip></el-table-column>
              <el-table-column label="缩写" prop="mcsx" min-width="100" show-overflow-tooltip></el-table-column>
              ...
              <el-table-column label="病案首页归并" prop="basygb" min-width="100px"></el-table-column>
              ...
              <el-table-column label="账簿类别" prop="zblb" min-width="70px">
                <template slot-scope="scope">
                  <div
                    :class="[scope.row.zblb == '1' ? 'blues' : 'reds']"
                  >{{scope.row.zblb == '1' ? '是' : '否'}}</div>
                </template>
              </el-table-column>
            </el-table>
          </pagenation-list>
        ...
        >
          ...
          <div class="row" style="border-bottom: none; padding-bottom: 0;margin-bottom: 0">
            ...
            >
              ...
              <el-row type="flex">
                <el-form-item label="医保住院项目" prop="ybzy">
                  <search-select
              ...
              <el-row class="row" style="justify-content: left">
                ...
                <el-row type="flex">
                  <el-form-item label="账簿类别" prop="zblb">
                    <el-input v-model="addFormData.zblb" placeholder="请输入"></el-input>
                  </el-form-item>
                </el-row>
            </el-form>
          </div>
    ...
    <detailDialog ref="detailDialog" v-bind:addFormData="addFormData"></detailDialog>
  </div>
</template>
<script lang="ts">
