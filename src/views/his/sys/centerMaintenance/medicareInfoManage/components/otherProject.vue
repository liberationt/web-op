        ...
        <div class="his-module his-small" style="padding: 8px 10px">
          ...
          >
            ...
            >
              ...
              <el-table-column label="名称" prop="sfmc" width="100" show-overflow-tooltip></el-table-column>
              <el-table-column label="缩写" prop="mcsx" width="100" show-overflow-tooltip></el-table-column>
              ...
              <el-table-column label="归并项目" prop="fylb" width="100px">
                <template slot-scope="scope">
                  <div>
              ...
              <el-table-column label="门诊归并" prop="mzgb" width="100px">
                <template slot-scope="scope">
                  <div>
              ...
              <el-table-column label="住院归并" prop="zygb" width="100px">
                <template slot-scope="scope">
                  <div>
        ...
        >
          ...
          <div class="row" style="border-bottom: none; padding-bottom: 0;margin-bottom: 0">
            ...
            >
              ...
              <el-row type="flex">
                <el-form-item label="住院使用" prop="zysyxm">
                  <search-select
              ...
              <el-row type="flex">
                <el-form-item label="医保住院项目" prop="ybzy">
                  <el-input v-model="addFormData.ybzy" placeholder="请输入"></el-input>
                </el-form-item>
