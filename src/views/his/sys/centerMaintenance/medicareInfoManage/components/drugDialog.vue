  ...
  >
    <div class="content his-sys-content">
      <div class="his-module his-small" style="padding: 8px 10px">
        ...
        <drugTransferIn ref="drugTransferIn"></drugTransferIn>
        <drugPayService ref="drugPayService"></drugPayService>
      </div>
    </div>
  </el-dialog>
</template>
...
import drugTransferIn from './drugTransferIn.vue'
import drugPayService from './drugPayService.vue'
// 命名文件名称，过滤器什么的都在这里写
@Component({
  name: 'medicalDialog',
  components: { drugTransferIn, drugPayService },
})
export default class extends Vue {
  ...
  //调入弹框
  private handleAdd() {
    ;(this.$refs.drugTransferIn as any).open()
  }
  //修改弹框
  private modify() {
    ;(this.$refs.drugPayService as any).open()
  }
}
</script>
