...
<template>
  <div class="content">
    <div class="his-module his-small ht">
      <div class="row">
        <div class="label">
          <div class="title">挂号操作员工作量查询</div>
      ...
      <div class="statement-box">
        <!-- <statement
          ref="statement"
          html-api="/op-service/ghrbReport/searchForCountWorks"
...
export default class extends Vue {
  ...
  private query(){
    ...
    this.src  = `${location.origin}/op-service/ghrbReport/searchForCountWorks?token=${localStorage.getItem('token')}&beginDay=${this.htmlSearchData.beginDay}&endDay=${this.htmlSearchData.endDay}&jgName=${encodeURIComponent(this.htmlSearchData.jgName)}`
  }
  ...
  private print(){
    ...
    let str = `${location.origin}/op-service/ghrbReport/searchForCountWorks?token=${localStorage.getItem('token')}&beginDay=${this.htmlSearchData.beginDay}&endDay=${this.htmlSearchData.endDay}&jgName=${encodeURIComponent(this.htmlSearchData.jgName)}`
