  ...
  <div class="content">
    <div class="his-module his-small ht">
      ...
      <div class="statement-box">
        <!-- <statement
          ref="statement"
          html-api="/op-service/ghrbReport/rechargeCardsDailyReport"
...
export default class extends Vue {
  ...
  private query(){
    ...
    this.src  = `${location.origin}/op-service/ghrbReport/rechargeCardsDailyReport?token=${localStorage.getItem('token')}&beginDay=${this.htmlSearchData.beginDay}&endDay=${this.htmlSearchData.endDay}&jgName=${encodeURIComponent(this.htmlSearchData.jgName)}`
  }
  // 打印
  private print(){
    // const statement: any = this.$refs.statement
    // statement.printTable()
    let str = `${location.origin}/op-service/ghrbReport/rechargeCardsDailyReport?token=${localStorage.getItem('token')}&beginDay=${this.htmlSearchData.beginDay}&endDay=${this.htmlSearchData.endDay}&jgName=${encodeURIComponent(this.htmlSearchData.jgName)}`
