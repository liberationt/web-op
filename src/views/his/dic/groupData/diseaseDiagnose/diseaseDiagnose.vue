        ...
        <div class="his-module">
          ...
          >
            <div slot="header" class="row">
              <div class="label">
                <h1 class="title">{{$t('diagnose.title1')}}</h1>
                <el-input v-model="searchData.dataValue"  :placeholder="$t('diagnose.phDiag')">
            ...
            >
              ...
              <el-table-column prop="dataValue" :label="$t('diagnose.code1')"></el-table-column>
              <el-table-column prop="dataValueRemark" :label="$t('diagnose.title1')"></el-table-column>
              <el-table-column
      ...
      <el-col class="ht" :span="8">
        <div class="his-module">
          ...
          <el-form v-model="formData" ref="formData" :rules="formValid" label-width="90px">
            ...
            <el-form-item :label="$t('diagnose.title1')" prop="dataValueRemark">
              <el-input v-model="formData.dataValueRemark" :placeholder="$t('diagnose.phName1')"></el-input>
            </el-form-item>
            <el-form-item :label="$t('diagnose.code1')" prop="dataValue">
              <el-input v-model="formData.dataValue" :placeholder="$t('diagnose.phCode1')"></el-input>
            </el-form-item>
          </el-form>
        </div>
      </el-col>
