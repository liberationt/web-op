  ...
  <div>
    <div class="his-module his-small">
      ...
      >
        ...
        <el-table-column width="120" label="保险编码(身份证)"></el-table-column>
        <el-table-column label="凭证号码"></el-table-column>
        <el-table-column width="100" label="出院日期"></el-table-column>
        <el-table-column width="150" label="住院本次结算住院天数"></el-table-column>
        ...
        <el-table-column width="100" label="类别"></el-table-column>
        <el-table-column width="100" label="交易费用总额"></el-table-column>
        <el-table-column width="150" label="医保结算范围费用总额"></el-table-column>
        ...
        <el-table-column width="100" label="分类自负合计"></el-table-column>
        <el-table-column width="110" label="分类自负住院费"></el-table-column>
        <el-table-column width="110" label="分类自负诊疗费"></el-table-column>
        <el-table-column width="110" label="分类自负治疗费"></el-table-column>
        <el-table-column width="110" label="分类自负护理费"></el-table-column>
        <el-table-column width="140" label="分类自负手术材料费"></el-table-column>
        <el-table-column width="110" label="分类自负检查费"></el-table-column>
        <el-table-column width="110" label="分类自负化验费"></el-table-column>
        <el-table-column width="110" label="分类自负摄片费"></el-table-column>
        <el-table-column width="110" label="分类自负透视费"></el-table-column>
        <el-table-column width="110" label="分类自负输血费"></el-table-column>
        <el-table-column width="110" label="分类自负输氧费"></el-table-column>
        <el-table-column width="110" label="分类自负西药费"></el-table-column>
        <el-table-column width="130" label="分类自负中成药费"></el-table-column>
        <el-table-column width="130" label="分类自负中草药费"></el-table-column>
        <el-table-column width="100" label="分类自负其他"></el-table-column>
        <el-table-column width="160" label="非医保结算范围个人自费"></el-table-column>
        ...
        <el-table-column width="100" label="个人现金支付"></el-table-column>
        <el-table-column width="95" label="统筹支付数"></el-table-column>
      </el-table>
    </div>
  </div>
</template>
