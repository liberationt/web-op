    ...
    <div class="his-module his-small">
      ...
      >
        ...
        >
          ...
          <el-table-column label="门诊号"></el-table-column>
          ...
          <el-table-column label="处方编号"></el-table-column>
          ...
          <el-table-column width="150" label="药品通用名/材料品牌"></el-table-column>
