    ...
    <div class="his-module his-small">
      ...
      >
        ...
        >
          ...
          <el-table-column width="100" label="现金支起其余"></el-table-column>
          <el-table-column width="110" label="统筹基金支付"></el-table-column>
          <el-table-column width="110" label="历年支付起付"></el-table-column>
          <el-table-column width="110" label="历年支付其余"></el-table-column>
          <el-table-column label="附加支付"></el-table-column>
          ...
          <el-table-column width="90" label="自负住院费"></el-table-column>
          <el-table-column width="90" label="自负诊疗费"></el-table-column>
          <el-table-column width="90" label="自负治疗费"></el-table-column>
          <el-table-column width="90" label="自负护理费"></el-table-column>
          <el-table-column width="110" label="自负手术材料费"></el-table-column>
          <el-table-column width="90" label="自负检查费"></el-table-column>
          <el-table-column width="90" label="自负化验费"></el-table-column>
          <el-table-column width="90" label="自负摄片费"></el-table-column>
          <el-table-column width="90" label="自负透视费"></el-table-column>
          <el-table-column width="90" label="自负输血费"></el-table-column>
          <el-table-column width="90" label="自负输氧费"></el-table-column>
          <el-table-column width="90" label="自负西药费"></el-table-column>
          <el-table-column width="110" label="自负中成药费"></el-table-column>
          <el-table-column width="110" label="自负中草药费"></el-table-column>
