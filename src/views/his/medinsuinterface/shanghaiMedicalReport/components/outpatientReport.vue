...
<template>
  <div>
    <div class="his-module his-small">
      ...
      <pagenation-list
        ref="pageTable"
        data-url='/op-service/shybdz/cztssbb'
        v-model="tableData"
      ...
      >
        ...
        >
          ...
          <el-table-column prop="bxid" width="120" label="保险编码(身份证)"></el-table-column>
          ...
          <el-table-column prop="fy11" label="挂号费"></el-table-column>
          ...
          <el-table-column prop="fy22" width="110" label="分类自负手术材料费"></el-table-column>
          ...
          <el-table-column prop="tczf" width="95" label="统筹支付数"></el-table-column>
        </el-table>
      </pagenation-list>
    </div>
  </div>
...
import { retrieval, reporting } from '@/api/his/medinsuinterface/outpatientReport.ts'
@Component({
