...
<template>
  <div>
    <div class="his-module his-small">
      ...
      <pagenation-list
        ref="pageTable"
        data-url="/op-service/shybdz/czdbsbb"
        v-model="tableData"
      ...
      >
        ...
        >
          ...
          <el-table-column prop="dbxm" label="大病项目"></el-table-column>
          <el-table-column prop="grxz" label="在退标识"></el-table-column>
          <el-table-column prop="jytotfy" width="100" label="交易费用总额"></el-table-column>
          <el-table-column prop="grxj" width="135" label="自负(个人现金支付)"></el-table-column>
          <el-table-column prop="tczf" width="100" label="统筹基金支付"></el-table-column>
          <el-table-column prop="grzfl" width="150" label="个人账户历年基金支付"></el-table-column>
          <el-table-column prop="fjbx" width="150" label="附加医疗保险基金支付"></el-table-column>
          <el-table-column prop="totfy" width="150" label="医保结算范围费用总额"></el-table-column>
          ...
          <el-table-column prop="flgrzf" width="100" label="分类自负合计"></el-table-column>
          <el-table-column prop="fy20" width="110" label="分类自负诊疗费"></el-table-column>
          <el-table-column prop="fy21" width="110" label="分类自负治疗费"></el-table-column>
          <el-table-column prop="fy22" width="110" label="分类自负手材费"></el-table-column>
          <el-table-column prop="fy23" width="110" label="分类自负检查费"></el-table-column>
          <el-table-column prop="fy24" width="110" label="分类自负化验费"></el-table-column>
          <el-table-column prop="fy25" width="110" label="分类自负摄片费"></el-table-column>
          <el-table-column prop="fy26" width="110" label="分类自负透视费"></el-table-column>
          <el-table-column prop="fy27" width="110" label="分类自负西药费"></el-table-column>
          <el-table-column prop="fy28" width="130" label="分类自负中成药费"></el-table-column>
          <el-table-column prop="fy29" width="130" label="分类自负中草药费"></el-table-column>
          <el-table-column prop="fy30" width="100" label="分类自负其他"></el-table-column>
          <el-table-column prop="zf" width="160" label="非医保结算范围个人自费"></el-table-column>
...
import { retrieval, reporting } from '@/api/his/medinsuinterface/medicalInsureReport2.ts'

@Component({
  name: 'medicalInsureReport2',
  filters: {},
  components: {}
})
export default class extends Vue {
  ...
  private currentDate: Array<any> = [] // 存放起止时间
