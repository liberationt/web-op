    ...
    <div class="his-module his-small">
      ...
      >
        ...
        >
          ...
          <el-table-column label="凭证编码"></el-table-column>
          ...
          <el-table-column label="在退标志"></el-table-column>
          <el-table-column width="100" label="交易费用总额"></el-table-column>
          <el-table-column width="140" label="自负(个人现金支付)"></el-table-column>
          <el-table-column label="当年支付"></el-table-column>
          <el-table-column label="历年支付"></el-table-column>
          <el-table-column width="100" label="统筹基金支付"></el-table-column>
          ...
          <el-table-column width="110" label="自负手材费"></el-table-column>
