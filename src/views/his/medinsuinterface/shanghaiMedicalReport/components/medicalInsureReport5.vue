...
<template>
  <div>
    <div class="his-module his-small">
      ...
      <pagenation-list
        ref="pageTable"
        data-url="/op-service/shybdz/ylhzbkbb"
        v-model="tableData"
      ...
      >
        ...
        >
          ...
          <el-table-column prop="ybzf" width="85" label="困资金支付"></el-table-column>
          <el-table-column prop="totfy" width="85" label="医保内总费用"></el-table-column>
          ...
          <el-table-column prop="zf20" width="110" label="自负诊疗费"></el-table-column>
          <el-table-column prop="zf21" width="110" label="自负治疗费"></el-table-column>
          <el-table-column prop="zf22" width="110" label="自负手材费"></el-table-column>
          <el-table-column prop="zf23" width="110" label="自负检查费"></el-table-column>
          <el-table-column prop="zf24" width="110" label="自负化验费"></el-table-column>
          <el-table-column prop="zf25" width="110" label="自负摄片费"></el-table-column>
          <el-table-column prop="zf26" width="110" label="自负透视费"></el-table-column>
          <el-table-column prop="zf27" width="110" label="自负西药费"></el-table-column>
          <el-table-column prop="zf28" width="130" label="自负中成药费"></el-table-column>
          <el-table-column prop="zf29" width="130" label="自负中草药费"></el-table-column>
          <el-table-column prop="zf30" width="100" label="自负其他"></el-table-column>
...
import { retrieval, reporting } from '@/api/his/medinsuinterface/medicalInsureReport5.ts'
@Component({
  name: 'medicalInsureReport5',
  filters: {},
  components: {}
})
