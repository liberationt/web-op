  ...
  <div>
    <div class="his-module his-small">
      ...
      >
        ...
        <el-table-column label="挂号费"></el-table-column>
        <el-table-column label="诊疗费"></el-table-column>
        <el-table-column label="交易总费用"></el-table-column>
        <el-table-column label="医保范围总额"></el-table-column>
        <el-table-column label="非医保范围自费"></el-table-column>
        <el-table-column label="交易时间"></el-table-column>
        <el-table-column label="医保类型"></el-table-column>
        <el-table-column label="结算类型"></el-table-column>
        <el-table-column label="退费标志"></el-table-column>
