    ...
    <div class="his-module his-small">
      ...
      >
        ...
        >
          ...
          <el-table-column width="130" label="本次结算住院天数"></el-table-column>
          <el-table-column width="130" label="住院结算开始时间"></el-table-column>
          <el-table-column width="100" label="入院诊断编码"></el-table-column>
          <el-table-column width="100" label="入院诊断说明"></el-table-column>
          <el-table-column width="130" label="住院结算结束日期"></el-table-column>
          <el-table-column width="100" label="急观住院标志"></el-table-column>
          <el-table-column label="出院标志"></el-table-column>
          <el-table-column width="100" label="出院诊断编码"></el-table-column>
          <el-table-column width="100" label="出院诊断说明"></el-table-column>
          <el-table-column width="100" label="治疗结果代码"></el-table-column>
        </el-table>
      </pagenation-list>
      <div
