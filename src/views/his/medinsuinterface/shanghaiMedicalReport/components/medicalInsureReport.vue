...
<template>
  <div>
    <div class="his-module his-small">
      ...
      <pagenation-list
        ref="pageTable"
        data-url="/op-service/shybdz/czptsbb"
        v-model="tableData"
      ...
      >
        ...
        >
          ...
          <el-table-column prop="bxid" width="150" label="身份证"></el-table-column>
          ...
          <el-table-column prop="fy20" width="90" label="自负诊疗费"></el-table-column>
          <el-table-column prop="fy21" width="90" label="自负治疗费"></el-table-column>
          <el-table-column prop="fy22" width="90" label="自负手材费"></el-table-column>
          <el-table-column prop="fy23" width="90" label="自负检查费"></el-table-column>
          <el-table-column prop="fy24" width="90" label="自负化验费"></el-table-column>
          <el-table-column prop="fy25" width="90" label="自负摄片费"></el-table-column>
          <el-table-column prop="fy26" width="90" label="自负透视费"></el-table-column>
          <el-table-column prop="fy27" width="90" label="自负西药费"></el-table-column>
          <el-table-column prop="fy28" width="100" label="自负中成药费"></el-table-column>
          <el-table-column prop="fy29" width="100" label="自负中草药费"></el-table-column>
          <el-table-column prop="fy30" label="自负其他"></el-table-column>
          ...
          <el-table-column prop="lsh" width="132" label="流水号"></el-table-column>
        </el-table>
      </pagenation-list>
    </div>
  </div>
...
import { retrieval, reporting } from '@/api/his/medinsuinterface/medicalInsureReport.ts'
@Component({
  name: 'medicalInsureReport',
  filters: {},
  components: {}
})
