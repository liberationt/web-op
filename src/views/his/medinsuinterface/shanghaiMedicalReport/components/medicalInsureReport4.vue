...
<template>
  <div>
    <div class="his-module his-small">
      ...
      <pagenation-list
        ref="pageTable"
        data-url="/op-service/shybdz/gsbxopbb"
        v-model="tableData"
      ...
      >
        ...
        >
          ...
          <el-table-column prop="gsid" width="85" label="工伤认定号"></el-table-column>
          ...
          <el-table-column prop="tczf" width="100" label="工伤资金支付"></el-table-column>
          ...
          <el-table-column prop="lsh" width="140" label="流水号"></el-table-column>
        </el-table>
      </pagenation-list>
    </div>
  </div>
...
import { retrieval, reporting } from '@/api/his/medinsuinterface/medicalInsureReport4.ts'
@Component({
  name: 'medicalInsureReport4',
  filters: {},
  components: {}
})
