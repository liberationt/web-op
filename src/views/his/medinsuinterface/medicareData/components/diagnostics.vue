  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-table-column prop="dataName" :label="$t('medicareData.explain')"></el-table-column>
        <el-table-column prop="dataType" :label="$t('medicareData.diseaseClass')"></el-table-column>
