<template>
  <div>
    ...
    >
      ...
      >
        <el-table-column prop="dataNum" :label="$t('medicareData.dataNum')" width="100px"></el-table-column>
        <el-table-column prop="dataName" :label="$t('medicareData.dataName')"></el-table-column>
        <el-table-column prop="dataCode" :label="$t('medicareData.dataCode')"></el-table-column>
...
export default class extends Vue {
  ...
  // 表格停用启用取消
  private stopOrStarCancel(data: any, index: Number) {
    console.log()
  }
}
</script>
