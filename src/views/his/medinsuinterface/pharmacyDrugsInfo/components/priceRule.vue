<!--
 * @Author: 曹俊
 * @LastEditTime: 2020-09-22 16:06:45
 * @LastEditors: Please set LastEditors
 * @Description: 药品价格规则
 * @FilePath: \web-op\src\views\his\medinsuinterface\pharmacyDrugsInfo\components\priceRule.vue
 -->
<template>
  <div>
    <pagenation-list
      ref="pageTable"
      data-url="/op-service/shybypjggz/queryPage"
      v-model="list"
    ...
    >
      ...
      >
        ...
        <el-table-column prop="jjdw" :label="$t('pharmacyDrugsInfo.jjdw')" width="75"></el-table-column>
        <el-table-column prop="jhjggzsm" :label="$t('pharmacyDrugsInfo.jhjggzsm')" min-width="130"></el-table-column>
        <el-table-column prop="jhgzjgje" :label="$t('pharmacyDrugsInfo.jhgzjgje')" min-width="130"></el-table-column>
        <el-table-column prop="xsjggzsm" :label="$t('pharmacyDrugsInfo.xsjggzsm')" min-width="130"></el-table-column>
        <el-table-column prop="xsgzjgje" :label="$t('pharmacyDrugsInfo.xsgzjgje')" min-width="130"></el-table-column>
    ...
    <div class="el-modal" v-show="isVisiable">
      <div class="v-modal-header">
        ...
        >{{isCreateAndEdit ? $t('pharmacyDrugsInfo.addPriceRule') : $t('pharmacyDrugsInfo.editPriceRule') }}</div>
      ...
      <div class="v-modal-wrap">
        <div class="v-modal-body">
          <el-form :model="form" :rules="addRules" ref="formValidate" label-width="100px">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item :label="$t('pharmacyDrugsInfo.jjdw')" prop="jjdw">
                  <el-input v-model="form.jjdw" :placeholder="$t('common.placeholder')"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('pharmacyDrugsInfo.jhjggzdm')" prop="jhjggzdm">
                  <el-input v-model="form.jhjggzdm" :placeholder="$t('common.placeholder')"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('pharmacyDrugsInfo.jhjggzsm')" prop="jhjggzsm">
                  <el-input v-model="form.jhjggzsm" :placeholder="$t('common.placeholder')"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item :label="$t('pharmacyDrugsInfo.jhgzjgje')" prop="jhgzjgje">
                  <el-input v-model="form.jhgzjgje" :placeholder="$t('common.placeholder')"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('pharmacyDrugsInfo.xsjggzsm')" prop="xsjggzsm">
                  <el-input v-model="form.xsjggzsm" :placeholder="$t('common.placeholder')"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('pharmacyDrugsInfo.xsgzjgje')" prop="xsgzjgje">
                  <el-input v-model="form.xsgzjgje" :placeholder="$t('common.placeholder')"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item :label="$t('pharmacyDrugsInfo.gzsyfw')" prop="gzsyfw">
                  <el-input v-model="form.gzsyfw" :placeholder="$t('common.placeholder')"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
...
import { enableStatus, addPriceRule, editPriceRule } from '@/api/his/medinsuinterface/pharmacyDrugsInfo.ts'
...
export default class extends Vue {
  ...
  private addRules = {
    ...
    jjdw: [
      {
        required: true,
        message: window.ele.$i18n.t('pharmacyDrugsInfo.jjdwTips'),
        trigger: 'blur',
      },
    ],
    jhjggzdm: [
      {
        required: true,
        message: window.ele.$i18n.t('pharmacyDrugsInfo.jhjggzdmTips'),
        trigger: 'blur',
      },
    ],
    jhjggzsm: [
      {
        required: true,
        message: window.ele.$i18n.t('pharmacyDrugsInfo.jhjggzsmTips'),
        trigger: 'blur',
      },
    ],
    jhgzjgje: [
      {
        required: true,
        message: window.ele.$i18n.t('pharmacyDrugsInfo.jhgzjgjeTips'),
        trigger: 'blur',
      },
    ],
    xsgzjgje: [
      {
        required: true,
        message: window.ele.$i18n.t('pharmacyDrugsInfo.xsgzjgjeTips'),
        trigger: 'blur',
      },
    ],
  }
  ...
  private addPharmacyDrug() {
    addPriceRule(this.form).then((res: any) => {
  ...
  private editPharmacyDrug() {
    editPriceRule(this.form).then((res: any) => {
      if (res.errorCode == 'SUCCESS') {
        // 编辑成功提示
        this.$notify({
