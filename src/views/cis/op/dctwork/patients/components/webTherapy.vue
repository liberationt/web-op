  ...
  <div class="content">
    <el-row :gutter="10" style="width: 100%">
      <div class="his-module his-small" style="height: auto">
        <div class="row">
          <div class="label">
            <div class="uhis-remedy">诊疗窗口</div>
          </div>
        </div>
        <!-- 对话框版块 -->
        <div :style="{ height: listSlotHeight - 192 + 'px' }">
          <div @click="click">点击</div>
          <iframe :src="'https://mp.tyhosp.com/dev/easemob/contact?' + webTime" allow="microphone;camera;midi;encrypted-media;" style="width: 100%; height: 100%" ref="iframe"></iframe>
        </div>
      </div>
    </el-row>
  </div>
...
export default class extends Vue {
  ...
  mounted() {
    ...
    const { jzlsh, jzzt } = this.data
    //this.iframeWin = this.$refs.iframe
