    ...
    <div class="his-module his-small">
      ...
      <div class="row" style="margin-top: 5px;">
        <div class="label">
          ...
          <el-divider direction="vertical"></el-divider>
          <!-- <el-button size="mini" type="text" ><i class="icon his-btn-save green"></i>保存</el-button> -->
      ...
      <el-form :model="deliveryData" ref="deliveryRef" class="retrieval" label-width="65px">
        <el-row type="flex">
          <el-form-item label="收件人" prop="shr">
            <el-input v-model="deliveryData.shr" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="收件电话" prop="shrdh">
            <el-input v-model="deliveryData.shrdh" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="联系地址" prop="psdz">
            <el-input v-model="deliveryData.psdz" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="物流状态" prop="pszt">
            <el-select placeholder="请选择" v-model="deliveryData.pszt" class="his-input" :disabled="disabled">
              <el-option label="未发货" value="0"></el-option>
              <el-option label="配送中" value="1"></el-option>
            </el-select>
          </el-form-item>
        ...
        <el-row type="flex">
          <el-form-item label="配送开始时间" prop="kssj" style="line-height: 12px;">
            <el-input v-model="deliveryData.kssj" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="配送结束时间" prop="jssj" style="line-height: 12px;">
            <el-input v-model="deliveryData.jssj" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="派件员" prop="pjy">
            <el-input v-model="deliveryData.pjy" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="派件电话" prop="pjydh">
            <el-input v-model="deliveryData.pjydh" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
        </el-row>
        <el-row type="flex">
          <el-form-item label="快递公司" prop="kdgs">
            <el-input v-model="deliveryData.kdgs" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="快递单号" prop="kddh">
            <el-input v-model="deliveryData.kddh" placeholder="请输入" :disabled="disabled"></el-input>
          </el-form-item>
          <el-form-item label="备注信息" prop="bz">
            <el-input v-model="deliveryData.bz" placeholder="无" :disabled="disabled"></el-input>
          </el-form-item>
